(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ngx-bootstrap/collapse'), require('hammerjs'), require('ngx-file-uploader-ampath'), require('@angular/platform-browser'), require('@angular/material/datepicker'), require('@angular/material/form-field'), require('@angular/material'), require('@angular/material/core'), require('@angular/material-moment-adapter'), require('@angular/material/select'), require('rxjs'), require('moment'), require('pdfmake/build/pdfmake.js'), require('pdfmake/build/vfs_fonts.js'), require('pdfmake/build/vfs_fonts'), require('lodash'), require('@angular/http'), require('@angular/common'), require('@angular/core'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('ngx-openmrs-formentry', ['exports', 'ngx-bootstrap/collapse', 'hammerjs', 'ngx-file-uploader-ampath', '@angular/platform-browser', '@angular/material/datepicker', '@angular/material/form-field', '@angular/material', '@angular/material/core', '@angular/material-moment-adapter', '@angular/material/select', 'rxjs', 'moment', 'pdfmake/build/pdfmake.js', 'pdfmake/build/vfs_fonts.js', 'pdfmake/build/vfs_fonts', 'lodash', '@angular/http', '@angular/common', '@angular/core', '@angular/forms'], factory) :
    (factory((global['ngx-openmrs-formentry'] = {}),global.collapse,null,global.ngxFileUploaderAmpath,global.ng.platformBrowser,global.ng.material.datepicker,global.ng.material['form-field'],global.ng.material,global.ng.material.core,global.ng['material-moment-adapter'],global.ng.material.select,global.rxjs,global.moment_,global.pdfMake,null,global.pdfFonts,global._,global.ng.http,global.ng.common,global.ng.core,global.ng.forms));
}(this, (function (exports,collapse,hammerjs,ngxFileUploaderAmpath,platformBrowser,datepicker,formField,material,core,materialMomentAdapter,select,rxjs,moment_,pdfMake,vfs_fonts_js,pdfFonts,_,http,common,i0,forms) { 'use strict';
    ...
    ***************************************************************************** */
            ...
            function (pages) {
                ...
                try {
                    for (var pages_1 = __values(pages), pages_1_1 = pages_1.next(); !pages_1_1.done; pages_1_1 = pages_1.next()) {
                        ...
                        try {
                            for (var _c = __values(page.page), _d = _c.next(); !_d.done; _d = _c.next()) {
            ...
            function (node, obsPayload) {
                ...
                if (deleted.length > 0) {
                    ...
                    try {
                        ...
                        try {
                            if (deletedObs_1_1 && !deletedObs_1_1.done && (_c = deletedObs_1.return))
                                _c.call(deletedObs_1);
                        }
                        finally {
                            if (e_10)
                                throw e_10.error;
                ...
                if (newObsPayload.length > 0) {
                    try {
                        ...
                        try {
                            if (newObsPayload_1_1 && !newObsPayload_1_1.done && (_d = newObsPayload_1.return))
                                _d.call(newObsPayload_1);
                        }
                        finally {
                            if (e_11)
                                throw e_11.error;
    ...
    var EncounterPdfViewerService = /** @class */ (function () {
            ...
            function (pages, form) {
                ...
                try {
                    for (var pages_1 = __values(pages), pages_1_1 = pages_1.next(); !pages_1_1.done; pages_1_1 = pages_1.next()) {
                        var page = pages_1_1.value;
                        try {
                            for (var _c = __values(form.rootNode.question.questions), _d = _c.next(); !_d.done; _d = _c.next()) {
         ...
         */
            function (val) {
                return moment$8(val, moment$8.ISO_8601, true).isValid();
            };
        /**
         * @param {?} value
         * @return {?}
        ...
        /** @nocollapse */ EncounterPdfViewerService.ngInjectableDef = i0.defineInjectable({ factory: function EncounterPdfViewerService_Factory() { return new EncounterPdfViewerService(i0.inject(EncounterViewerService), i0.inject(ObsValueAdapter)); }, token: EncounterPdfViewerService, providedIn: "root" });
...
//# sourceMappingURL=ngx-openmrs-formentry.umd.js.map