...
//     const failResult = service.generatePdfDefinition(form);
...
//     const successResult = service.generatePdfDefinition(form);
//     expect(successResult.content.length).toBeGreaterThan(0);
//     expect(successResult.styles).toBeTruthy();
//   });

//   it(`should have a displayPdf function that appends patient and confidentiality information to the PDF footer and
//     creates the eventual PDF document`, () => {
//     const failResult = service.displayPdf(form);
...
//     const successResult = service.displayPdf(form);
//   });
...
//     const failResult = service.getPages(pages, form);
...
//       const successResult = service.getPages(pages, form);
//       const pageLabel = successResult['0'].table.body[0][0].text;
...
//     const result = service.getSections(sections, form);
//     const sectionLabel = result[0][0].table.body[0][0].text;
...
//     const result = service.getSectionData(nodes, form);
//     const answer = result.stack[0].text[1].text;
